...
static RzCmdStatus rz_cmd_example_handler(RzCore *core, int argc, const char **argv) {
...
static bool rz_cmd_example_init(RzCore *core) {
	...
	RZ_LOG_ERROR("This init was called!\n");
...
static bool rz_cmd_example_fini(RzCore *core) {
	 ...
	 * end sockets, etc..) */
	RZ_LOG_ERROR("This fini was called!\n");
	return true;
}

static bool rz_cmd_example_analysis(RzCore *core) {
	/* This callback is called when the analysis
	 * step is executed */
	RZ_LOG_ERROR("This analysis method was called!\n");
	return true;
}
...
RzCorePlugin rz_core_plugin_example = {
	...
	.analysis = rz_cmd_example_analysis,
};
